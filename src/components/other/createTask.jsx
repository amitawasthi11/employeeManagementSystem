  ...
  return (
        ...
        <div className='p-5 bg-[#1c1c1c] mt-7 rounded'>
           ...
           <div> 
            ...
            <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4 ' type=" " placeholder='employee name' />
            </div>
           <div>
           ...
           <div className='w-2/5 flex flex-col items-start'>
            ...
            <textarea className='w-full h-44 text-sm py-2 px-4 rounded outline-none bg-transparent border-[1px] border-gray-400'   name="" id="" rows="10 " col="30"></textarea>
